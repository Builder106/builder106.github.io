...
**[OSS Ledger](oss-contribution-tracker/)** — a self-contained static page tracking my open-source contributions toward GSoC 2027, generated by `oss-contribution-tracker/refresh.py`into`public/oss-contribution-tracker/` and deployed alongside the portfolio at [yinkavaughan.me/oss-contribution-tracker/](https://yinkavaughan.me/oss-contribution-tracker/). See its own [README](oss-contribution-tracker/README.md) for how it updates and how activity monitoring works.

**[Multi-Resume Kit](multi-resume-kit/)** — a genericized, reusable version of the LaTeX system I use to maintain several role-targeted resumes in three presentation variants each from shared assets. See its own [README](multi-resume-kit/README.md) for the shared-asset pattern, the three-variant convention, and two real LaTeX gotchas it took a full session to find. Live preview: [yinkavaughan.me/multi-resume-kit/](https://yinkavaughan.me/multi-resume-kit/).
